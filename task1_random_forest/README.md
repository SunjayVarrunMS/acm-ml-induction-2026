...
Feature importance (top 5): `Sex` (0.316) dominates by a wide margin, then `Title` (0.161), `Pclass` (0.100), `FareBin` (0.091), `FamilySize` (0.079) — matches the historical "women and children first, and class mattered" account of the evacuation.
